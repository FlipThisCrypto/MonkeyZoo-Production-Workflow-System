...
Total handlers scanned: 170

| Classification | Count |
|----------------|-------|
| cleanup-suppression | 30 |
| intentional-fallback | 55 |
| re-raised | 54 |
| reported | 31 |
...
|------|------|---------|----------------|--------|
| 00_SYSTEM/scripts/assemble_pages.py | 42 | `OSError` | intentional-fallback | Narrow handler with fallback assignment/return. |
...
| 00_SYSTEM/scripts/genesis/genesis_charart.py | 327 | `BaseException` | re-raised | Exception is re-raised or wrapped. |
| 00_SYSTEM/scripts/genesis/genesis_charart.py | 467 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| 00_SYSTEM/scripts/genesis/genesis_release.py | 142 | `ValueError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| 00_SYSTEM/scripts/tests/test_validate_issue.py | 63 | `SystemExit` | intentional-fallback | Narrow handler with fallback assignment/return. |
| 00_SYSTEM/scripts/validate_issue.py | 52 | `FileNotFoundError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| 00_SYSTEM/scripts/validate_issue.py | 55 | `json.JSONDecodeError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| 00_SYSTEM/scripts/validate_issue.py | 79 | `ImportError` | intentional-fallback | Narrow handler with fallback assignment/return. |
...
| character-bibles/_review_app/art_queue_workspace.py | 66 | `ValueError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| character-bibles/_review_app/art_queue_workspace.py | 184 | `ArtQueueError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| character-bibles/_review_app/issue_workflow.py | 139 | `ValueError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| character-bibles/_review_app/issue_workflow.py | 257 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| character-bibles/_review_app/page_panel_workspace.py | 136 | `ValueError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| character-bibles/_review_app/story_workspace.py | 181 | `ValueError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| character-bibles/_review_app/tests/test_bible_store.py | 327 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| character-bibles/_review_app/visual_qa_workspace.py | 170 | `VisualQAError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| character-bibles/_schema/validate-character-bibles.py | 223 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| docs/export_static_catalog.py | 148 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| docs/export_static_issues.py | 22 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| docs/export_static_issues.py | 30 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| docs/export_static_issues.py | 34 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| docs/export_static_issues.py | 38 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| docs/export_static_issues.py | 42 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| docs/export_static_issues.py | 46 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| docs/export_static_issues.py | 50 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| docs/verify_static_site.py | 62 | `ValueError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| scripts/drive_issue_01_neonblue_story.py | 43 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| scripts/drive_issue_02_static_story.py | 38 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| scripts/live_app_test_issue.py | 69 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| scripts/live_app_test_issue.py | 387 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| scripts/rc_real_issue_run.py | 80 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| scripts/rc_real_issue_run.py | 471 | `Exception` | re-raised | Exception is re-raised or wrapped. |
| scripts/silent_failure_audit.py | 376 | `ValueError` | intentional-fallback | Narrow handler with fallback assignment/return. |
| scripts/silent_failure_audit.py | 420 | `(OSError, subprocess.CalledProcessError)` | intentional-fallback | Narrow handler with fallback assignment/return. |
| scripts/silent_failure_audit.py | 454 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| scripts/silent_failure_audit.py | 461 | `SyntaxError` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
| scripts/silent_failure_audit.py | 464 | `Exception` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
| scripts/workflow_engine.py | 752 | `(WorkflowError, bible_store.BibleStoreError, story_context.StoryContextError)` | reported | Failure is reported (reporter call, accumulator, or exception passed to a call). |
...
**Unreviewed by design:** 30 handlers are classified
