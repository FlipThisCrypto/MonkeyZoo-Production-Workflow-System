...
| U05 | Medium | Repair | `character-bibles/_review_app/release_workspace.py:90` | Release gate and CLI packager disagree on where the final cover lives; 3 of 7 real issues have a cover the Studio cannot see | **FIXED** (r2-i21) |
